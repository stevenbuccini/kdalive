...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b8e5e5d19e18',layout:'grid',pagination:'numbers',postSpacing:'40',postWidth:'300',matchHeight:0,isRTL:false});});$(window).on('load',function(){$('.fl-node-5b8e5e5d19e18 .fl-post-grid').masonry('reloadItems');});})(jQuery);