...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5be5a7643a71d',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:0,isRTL:false});});$(window).on('load',function(){$('.fl-node-5be5a7643a71d .fl-post-grid').masonry('reloadItems');});})(jQuery);