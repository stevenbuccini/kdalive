...
var wpAjaxUrl='https://kdalive.com/wp-admin/admin-ajax.php';var flBuilderUrl='https://kdalive.com/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://kdalive.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://kdalive.com/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5bc3f2be6b122',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:1,isRTL:false});});$(window).on('load',function(){$('.fl-node-5bc3f2be6b122 .fl-post-grid').masonry('reloadItems');});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b8e644306eee',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:0,isRTL:false});});$(window).on('load',function(){$('.fl-node-5b8e644306eee .fl-post-grid').masonry('reloadItems');});})(jQuery);