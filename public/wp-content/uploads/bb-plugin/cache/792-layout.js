...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5bcf016a1f004',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:0,isRTL:false});});$(window).on('load',function(){$('.fl-node-5bcf016a1f004 .fl-post-grid').masonry('reloadItems');});})(jQuery);